...
| Outcaste | 27 | 50-54, 58-59, 62-64, 92, 121-122 | **NO** |
| Fair Folk | 27 | 205-211, 279-283 | 279-283 YES (MF chapter, **already authored**); 205-211 NO |
| core | 24 | 336-338, 340-341, 343-345 | partially (Solars/ subset) |
| Ruins of Rathess | 18 | 80-84, 86-88, 91, 194 | **NO** |
| Autochthonians | 17 | 182-190 | **NO** |
| Abyssals | 16 | 254-261 | YES (Abyssals/Traits) |
| Book of Three Circles | 14 | 24-27, 92-96 | **NO** |
| Player's Guide | 14 | 192-195, 211 | **NO** |
| Abyssal castebooks | 13 | 75-81 | **NO** |
| Castebook Dawn | 11 | 78-81 | YES (Solar Castebooks) |
| Time of Tumult | 11 | 15, 23, 49, 94-95 | **NO** |
| Castebook Twilight | 12 | 79-81 | YES (Solar Castebooks) |
| Salt & Smoke | 11 | 89, 119-124 | **NO** |
| Castebook Eclipse | 9 | 79-81 | YES (Solar Castebooks) |
| Castebook Night | 8 | 79-81 | YES (Solar Castebooks) |
| Abyssal Exalted (E:Ab) | 6 | 79-81 | **NO** |
| Abyssal War | 6 | 79-81 | **NO** |
| Storyteller's Companion | 6 | 77-80 | partially (CH3 only) |
| Castebook Zenith | 5 | 80-81 | YES (Solar Castebooks) |
| Savage Seas | 4 | 123-124, 126-127 | **NO** |
| Abyssal Fire | 4 | 79-81 | **NO** |
| Abyssal Void | 4 | 80-81 | **NO** |
| Cult of the Illuminated | 5 | 69-70 | YES (Illuminated) |
| Savant & Sorcerer | 5 | 40-43 | **NO** |
| Halta | 5 | 93-95 | **NO** |
| Sidereals | 3 | 24, 39 | YES (Sidereals) |
| Coin of the Realm | 1 | 31 | **NO** |

Approx. **90 entries are authorable from pages already on this machine** (the Castebook
79-81s, the core subset, Abyssal Traits 254-261, Sidereals, Illuminated, STC CH3, and
the Mountain Folk pp.279-283 slice — the latter already shipped as the ten rated
artifacts in `data/artifacts.json`). Everything else needs the human to sync source
pages.
...
- `data/artifacts.json` (SHIPPED 2026-08-08): the ten Mountain Folk rated artifacts
  (pp.279-283) + the four stat-blocked gear rows + the six dual-nature devices.
