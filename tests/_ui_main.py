...
from exalted_builder.models.character import Character, Caste, PlayState, Damage, Weapon, Armor
...
CHAR_PLAY = Character(id="p", name="Player", caste=Caste.DAWN)
...
CHAR_XP = Character(id="x", name="Veteran", caste=Caste.DAWN)
