...
| 4 | **Collection** | the app's *actual* design language — a QTreeWidget like Gear and Advantages, grouped by category, toolbar above, detail pane beside. Dots ride in the Rating column. **Two sub-tabs:** *Attributes & Abilities* (third column = Specialties) and *Virtues & Advantages* (third column = Notes), the latter holding everything that had no home. |
